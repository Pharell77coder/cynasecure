      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.empty}>
            ...
            <Text style={styles.emptyText}>Vos commandes apparaîtront ici une fois passées.</Text>
                ...
                <View style={styles.details}>
                  {order.items.map((i) => (
                    <View key={i.id} style={styles.detailLine}>
                      <Text style={styles.detailLabel}>{i.product_name} × {i.quantity}</Text>
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: typography['2xl'], fontWeight: '900', color: colors.primary, marginBottom: spacing[4] },
