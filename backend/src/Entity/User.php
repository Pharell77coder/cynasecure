...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function addUsercart(CartItem $usercart): static
    {
        if (!$this->usercart->contains($usercart)) {
            $this->usercart->add($usercart);
    ...
    public function removeUsercart(CartItem $usercart): static
    {
